...
parser.add_argument('--scope', default='ct_img2img', dest='scope')
...
parser.add_argument('--lr_type_prj', type=str, default='residual', choices=['residual', 'plain', 'consistency'], dest='lr_type_prj')
parser.add_argument('--lr_type_img', type=str, default='residual', choices=['residual', 'plain', 'consistency'], dest='lr_type_img')
...
parser.add_argument('--nstage', type=int, default=0, dest='nstage')
